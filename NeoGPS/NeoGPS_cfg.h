 ...
 * features of GCC to reduce RAM requirements.  Although it was expected to slightly increase 
 * execution time and code size, the reverse is true on 8-bit AVRs: 
 * the code is smaller and faster with packing enabled.
 *
